...
def load_image(image_path, model_size):
    ''' This function loads the image from imge_path (param) and process it. Processing includes converting
...
def prep_image(img, model_size):
	''' This function process the image by resizing it to model_size (param), then normalizing it with
        vlaue 255 and expanding dimentions of it.
...
def load_labels(labels_file):
    ''' This function opens the lable file and returns the text data.
